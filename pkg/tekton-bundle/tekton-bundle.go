...
func getTasksBundlePath(isOpenshift bool) string {
	if isOpenshift {
		return filepath.Join(tektonTasksOKDBundleDir, "kubevirt-tekton-tasks-okd-"+operands.Version+".yaml")
	}
	return filepath.Join(tektonTasksKubernetesBundleDir, "kubevirt-tekton-tasks-kubernetes-"+operands.Version+".yaml")
}
