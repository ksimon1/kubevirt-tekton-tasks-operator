...
import (
	...
	"github.com/kubevirt/kubevirt-tekton-tasks-operator/controllers"
	"github.com/kubevirt/kubevirt-tekton-tasks-operator/pkg/common"
	"github.com/kubevirt/kubevirt-tekton-tasks-operator/pkg/environment"
...
func main() {
	...
	if environment.IsCertManager() {
		...
		if err = controllers.CreateAndSetupReconciler(mgr); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "TektonTasks")
			os.Exit(1)
		}
